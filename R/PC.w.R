...
rr_finaladj=rep(1,(rawmax+1)) #final adjustment to raw score param
rr_value=seq(0,rawmax)
rr_value[1]=extr_lo
if(extr_hi==99) rr_value[rawmax+1]=rawmax-.5 else rr_value[rawmax+1]=extr_hi

for (rr in 1:(rawmax+1)) {paramrev=0;                    
